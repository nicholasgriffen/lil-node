...
module.exports = {
    run: function() {
        ...
        console.log('cookie#set takes a res, name, and value, and invokes res.setHeader with name and value')
        ...
        console.log('cookie#expire takes a res, and name and invokes res.setHeader with name, \'\'; Expires=Mon Jan 01 1990 00:00:00 GMT-0700 (GMT-07:00)')
